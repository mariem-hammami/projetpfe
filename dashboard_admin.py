...
class DashboardAdmin:
    ...
    def __init__(self, username):
        ...
        # ----- Ajouter image de fond une seule fois -----
        ...
        self.btn_logout = tk.Button(self.root, text="➤", command=self.logout,
                                    bg="#D32F2F", fg="white", font=("Arial", 18, "bold"),
    ...
    def on_resize(self, event):
        ...
        # Redimensionner l'image sans créer de nouvelle image Canvas
        ...
        self.canvas.coords(self.win_logout, event.width - 50, event.height - 50)
